...
// The project blurb (Figma 382-1635, node 382:1640). One paragraph, RTL.
const ABOUT_TEXT =
  'הארכיטיפ של המפלצת הוא פרויקט גמר ב־B.Des תקשורת חזותית, אוניברסיטת חיפה, 2026. הפרויקט בוחן מפלצות כדימויים חזותיים של פחד, בלבול, יראה וצורך בביטחון. במסגרת העבודה נאספו 39 מפלצות ממסורות שונות, וחולקו לשבעה פרקים רגשיים לפי מקור תרבותי, תפקיד מיתי, מבנה חזותי והרגש שהן מגלמות. האתר הוא תרגום דיגיטלי של המחקר: מבחן דימויים קצר, מאגר מפלצות ועמודי מידע לכל מפלצת. הוא אינו מחליף את הספר, אלא מציע דרך נוספת לפגוש את מערכת הסיווג שנבנתה בפרויקט. המחקר מבוסס על מקורות אקדמיים ומיתולוגיים המפורטים בספר. כלי AI שימשו בתהליך העבודה ככלי עזר למחקר, ארגון, ניסוח ופיתוח חזותי.';
